...
import "./IBionicPod.sol";
import "./IBeaconChainOracle.sol";
import "./IPausable.sol";

/**
 * @title Interface for factory that creates and manages solo staking pods that have their withdrawal credentials pointed to Bionic.
 * @author Layr Labs, Inc.
 * @notice Terms of Service: https://docs.bionicprotocol.com/overview/terms-of-service
 */

interface IBionicPodManager is IPausable {
    /**
    ...
    /// @notice Returns the address of the `podOwner`'s BionicPod if it has been deployed.
    ...
    function getPod(address podOwner) external view returns(IBionicPod);
