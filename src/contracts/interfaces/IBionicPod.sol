 ...
 */
interface IBionicPod {
    enum VALIDATOR_STATUS {
        INACTIVE, // doesnt exist
        ACTIVE, // staked on ethpos and withdrawal credentials are pointed to the BionicPod
    ...
    struct ValidatorInfo {
        ...
        // amount of beacon chain ETH restaked on Bionic in gwei
    ...
    /// @notice the amount of execution layer ETH in this contract that is staked in Bionic (i.e. withdrawn from beaconchain but not Bionic), 
    function withdrawableRestakedExecutionLayerGwei() external view returns(uint64);

    /// @notice Used to initialize the pointers to contracts crucial to the pod's functionality, in beacon proxy construction from BionicPodManager
    ...
    function bionicPodManager() external view returns (IBionicPodManager);
    ...
    /**
     * @notice This function records an overcommitment of stake to Bionic on behalf of a certain ETH validator.
    ...
    /**
     * @notice This function records a full withdrawal on behalf of one of the Ethereum validators for this BionicPod
    ...
    /// @notice called by the bionicPodManager to decrement the withdrawableRestakedExecutionLayerGwei 
    ...
    /// @notice called by the bionicPodManager to increment the withdrawableRestakedExecutionLayerGwei 
