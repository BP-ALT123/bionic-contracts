...
/**
 * @title Interface for the primary entrypoint for funds into Bionic.
...
interface IStrategyManager {
    ...
    */
    ...
    /// @notice Returns the single, central Delegation contract of Bionic
    function delegation() external view returns (IDelegationManager);

    /// @notice Returns the single, central Slasher contract of Bionic
