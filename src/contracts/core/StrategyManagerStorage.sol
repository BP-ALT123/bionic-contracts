...
abstract contract StrategyManagerStorage is IStrategyManager {
     ...
     * @dev Note that the withdrawal delay is not enforced on withdrawals of 'beaconChainETH', as the BionicPods have their own separate delay mechanic
     ...
     * replaced by a simpler design that prevents withdrawals from Bionic before withdrawals from the beacon chain, which
