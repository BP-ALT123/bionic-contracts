...
/**
 * @title The primary 'slashing' contract for Bionic.
...
contract Slasher is Initializable, OwnableUpgradeable, ISlasher, Pausable {
    ...
    /// @notice The central StrategyManager contract of Bionic
    IStrategyManager public immutable strategyManager;
    /// @notice The DelegationManager contract of Bionic
    ...
    /// @notice Emitted when `previouslySlashedAddress` is 'unfrozen', allowing them to again move deposited funds within Bionic.
