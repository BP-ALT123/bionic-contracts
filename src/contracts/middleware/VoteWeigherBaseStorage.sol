...
abstract contract VoteWeigherBaseStorage is Initializable, IVoteWeigher {
    ...
    /// @notice The address of the Delegation contract for Bionic.
    IDelegationManager public immutable delegation;
    
    /// @notice The address of the StrategyManager contract for Bionic.
    IStrategyManager public immutable strategyManager;

    /// @notice The address of the Slasher contract for Bionic.
