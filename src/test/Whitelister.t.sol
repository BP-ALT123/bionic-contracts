...
contract WhitelisterTests is BionicTestHelper {
    ...
    function setUp() public virtual override{
        ...
        dummyStrat = StrategyBase(
            address(
                new TransparentUpgradeableProxy(
                        ...
                        abi.encodeWithSelector(StrategyBase.initialize.selector, dummyToken, BionicPauserReg)
                    )
                )
        );
        ...
        VoteWeigherBaseStorage.StrategyAndWeightingMultiplier[] memory bionicStratsAndMultipliers =
            ...
            bionicStratsAndMultipliers[0].multiplier = 1e18;
            ...
            abi.encodeWithSelector(BLSRegistry.initialize.selector, address(whiteLister), true, _quorumBips, ethStratsAndMultipliers, bionicStratsAndMultipliers)
        );
            cheats.stopPrank();
