...
contract ServiceManagerMock is IServiceManager, DSTest {
    ...
    /// @notice Permissioned function that causes the ServiceManager to freeze the operator on Bionic, through a call to the Slasher contract
    ...
    /// @notice The Delegation contract of Bionic.
