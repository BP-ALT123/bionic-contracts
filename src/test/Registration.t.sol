...
contract RegistrationTests is BionicTestHelper {
    ...
    function initializeMiddlewares() public {
        ...
        strategyManagerMock.setAddresses(delegation, bionicPodManager, slasher);
        ...
        dataLayrProxyAdmin.upgradeAndCall(
                ...
                abi.encodeWithSelector(BLSRegistry.initialize.selector, address(this), false, _quorumBips, ethStratsAndMultipliers, bionicStratsAndMultipliers)
            );
    ...
    function testRegisterOperator(address operator, uint32 operatorIndex, string calldata socket) public fuzzedAddress(operator) {
        ...
        uint256 bionicToDeposit = 1e18;
        _testDepositWeth(operator, wethToDeposit);
        _testDepositBionic(operator, bionicToDeposit);
